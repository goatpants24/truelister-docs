...
/**
 * Bolt: Restrict MADE_IN_REGEX capturing group to horizontal whitespace ([\t ]) instead of \s.
 * Prevents regex backtracking across newlines (\n, \r) during multi-line OCR tag parsing,
 * avoiding line bleed into result.notes and reducing CPU cycles.
 */
...
export function parseTagText(rawText: string): Partial<CatalogItem> {
  ...
  // ── Brand Detection ──
  /** Bolt: Use RegExp.exec to eliminate intermediate array allocations from String.prototype.match */
