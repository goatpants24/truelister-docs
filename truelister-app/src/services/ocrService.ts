...
/**
 * Bolt Performance Optimization: Single-line Country Extraction
 * Restricting country extraction to horizontal whitespace ([\t ]) prevents the capturing group
 * from matching newlines (\n, \r). This eliminates multi-line regex backtracking and avoids
 * capturing subsequent tag lines (e.g. care instructions, materials) into result.notes.
 */
