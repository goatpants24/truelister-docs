 ...
 * Restrict country extraction group to horizontal whitespace ([\t ]) instead of \s.
 * Prevents catastrophic regex backtracking across line breaks (\n, \r) in multi-line OCR text
