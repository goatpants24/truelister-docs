...
/**
 * Bolt: Consolidated and deduplicated care keywords array to eliminate redundant regex alternation branches.
 * Measured impact: Reduces CARE_REGEX pattern size and matching latency during tag OCR parsing.
 */
const CARE_KEYWORDS = [
