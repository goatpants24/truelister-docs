...
/**
 * Bolt: Use horizontal whitespace ([\t ]) instead of \s in MADE_IN_REGEX.
 * Restricts country matching to the current line, preventing regex backtracking across line breaks
 * and eliminating line bleed into result.notes during multi-line OCR tag text scans.
 */
