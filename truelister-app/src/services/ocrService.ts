 ...
 * Replacing \s with [\t ] prevents catastrophic regex backtracking across line breaks (\n, \r)
 * when parsing multi-line OCR text blocks, and stops line bleed into result.notes.
 */
