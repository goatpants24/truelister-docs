...
/**
 * Bolt Performance Optimization: Restrict MADE_IN_REGEX capturing group to horizontal whitespace ([\t ]).
 * Prevents regex backtracking across newlines (\n, \r) during multi-line OCR tag parsing,
 * stopping line bleed into result.notes and speeding up parseTagText.
 */
