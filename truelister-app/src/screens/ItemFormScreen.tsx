    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={64}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.row}>
          ...
          <View style={{ flex: 1 }}><Text style={styles.label}>Size</Text><TextInput ref={sizeInput} style={styles.input} value={item.size} onChangeText={(v) => updateField('size', v)} placeholder="M" placeholderTextColor="#4a5568" accessibilityLabel="Item Size" returnKeyType="next" onSubmitEditing={() => priceInput.current?.focus()} blurOnSubmit={false} /></View>
        </View>
        ...
        <View style={styles.field}>
          ...
          <TextInput ref={priceInput} style={styles.input} value={item.price} onChangeText={(v) => updateField('price', v)} placeholder="0.00" keyboardType="decimal-pad" placeholderTextColor="#4a5568" accessibilityLabel="Item Price" returnKeyType="done" />
        </View>
