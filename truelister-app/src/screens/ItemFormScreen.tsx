      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.field}>
          ...
          <TextInput
            ...
            accessibilityHint="Short descriptive name for the item"
            returnKeyType="next"
        ...
        <View style={styles.field}>
          <View style={styles.labelRow}>
            ...
            <TouchableOpacity
              ...
              accessibilityHint="Opens Google Image search in your browser"
              hitSlop={{ top: 15, bottom: 15, left: 15, right: 15 }}
            >
          ...
          <TextInput
            ...
            accessibilityHint="The maker or designer of the item"
            returnKeyType="next"
        ...
        <View style={styles.row}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <TextInput
              ...
              accessibilityHint="Size of the item, e.g. Medium or 32x34"
              returnKeyType="next"
        ...
        <View style={styles.field}>
          <View style={styles.labelRow}>
            ...
            <TouchableOpacity
              ...
              accessibilityHint="Opens eBay sold listings in your browser"
              hitSlop={{ top: 15, bottom: 15, left: 15, right: 15 }}
            >
          ...
          <TextInput
            ...
            accessibilityHint="Listing price in USD"
            returnKeyType="next"
        ...
        <View style={styles.field}>
          ...
          <TextInput
            ...
            accessibilityHint="Any additional details or defects"
