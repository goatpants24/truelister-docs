      ...
      >
        ...
        {photo && (
          <View style={styles.photoPreview}>
            <Image
              source={{ uri: photo.compressed.uri }}
              style={styles.photoImage}
              resizeMode="cover"
            />
            <Text style={styles.photoSize}>
              {formatFileSize(photo.compressed.fileSize ?? 0)}{' '}
              · {photo.compressed.width}×{photo.compressed.height}
            </Text>
          </View>
        )}
        ...
        <View style={styles.field}>
          ...
          <TextInput
            style={[
              styles.input,
              item.designerBrand && ocrRawText ? styles.inputOcr : null,
            ]}
        ...
        <View style={styles.field}>
          ...
          <TextInput
            style={[
              styles.input,
              item.fabricMaterial && ocrRawText ? styles.inputOcr : null,
            ]}
