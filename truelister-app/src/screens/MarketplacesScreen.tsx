 ...
 * Wrapping MarketplaceCard with React.memo prevents unnecessary re-renders of
 * un-edited marketplace cards when parent screen state or sibling card state updates.
 */
