...
/**
 * ⚡ BOLT PERFORMANCE OPTIMIZATION: Hoisted Grid Item Dimensions & Pre-Allocated Styles
 * Static dimension styles for thumbnail sizes eliminate inline object allocations
 * ({ width, height }) on every render pass per item in grid mode.
 */
