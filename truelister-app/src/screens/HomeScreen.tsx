  ...
  return (
    ...
    >
      ...
      <View style={styles.listTextContainer}>
        ...
        {item.price ? (
          <Text style={[styles.listPrice, isSold && { textDecorationLine: 'line-through', color: '#64748b' }]}>
            ${item.price}
          </Text>
        ) : null}
        {item.marketplace ? (
...
const styles = StyleSheet.create({
  ...
  soldOverlay: { position: 'absolute', top: 0, left: 0, backgroundColor: 'rgba(15, 17, 23, 0.65)', borderRadius: 8, justifyContent: 'center', alignItems: 'center' },
  soldText: { color: '#f87171', fontWeight: '900', fontSize: 14, letterSpacing: 1 },
  soldBadge: { backgroundColor: 'rgba(248, 113, 113, 0.15)', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, borderWidth: 0.5, borderColor: '#f87171' },
  soldBadgeText: { color: '#f87171', fontSize: 9, fontWeight: '800' },
});
