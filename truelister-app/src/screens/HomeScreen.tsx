...
export default function HomeScreen() {
  ...
  // Stale-While-Revalidate: Only show full-screen spinner on first load
  ...
  const handleEditItem = useCallback((item: CatalogItem) => {
    // Navigation payload reduced: existingItems is only needed when creating new,
    // not when editing existing (data is already in the item).
    navigation.navigate('ItemForm', { item });
  }, [navigation]);

  /** Optimized render function using the memoized GridItem component */
  ...
  /** Optimized render function using the memoized ListItem component */
