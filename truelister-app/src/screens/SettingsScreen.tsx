    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionDesc}>
          Your catalog sheet ID. Find it in the URL of your spreadsheet between /d/ and /edit.
        </Text>
        <TextInput
          style={styles.input}
          value={spreadsheetId}
        ...
        <View style={styles.buttonRow}>
          <TouchableOpacity
            ...
            onPress={() =>
              Linking.openURL(
                `https://docs.google.com/spreadsheets/d/${spreadsheetId || '1QHrXKkuh-6bNUyeYgp8jZrdP3t8MzBSyx-8k-GjFOcI'}/edit`
              )
            }
